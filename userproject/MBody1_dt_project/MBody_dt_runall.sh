...
dtarray=(0.001 0.005 0.01 0.02 0.05 0.1 0.2)
...
do
	...
	./generate_run 0 100 10000 20 100 0.0025 ${outname} MBody1 0 DOUBLE 1
	cp ${outname}_output ${outname}_CPU1_dt${dtarray[${DTind}]} -r
	...
	do
		...
		#ls
		#mkdir -p ${outdir}_CPU
		#cp ${outname}_output/dttest.* ${outdir}_CPU/
	done
done
